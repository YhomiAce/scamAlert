...
?>
 ...
 <main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Impersonation Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/impersonator-scamc645.png?sfvrsn=382c1a2d_2" alt="Impersonation Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS AN Impersonation Scam? <br />
                    </h1>
                    <p class="lead"><p>There are several variations of this scam. In many variations of this scam, it involves a phone call from someone purporting to be a government official (e.g. a police officer, immigration officer or court official) or staff from a bank or telecommunication service provider.&nbsp;<br />
<br />
<strong>China Officials Impersonation Scam</strong></p>
<p>In this scam, the caller might claim to be a government official, an employee or representative of a Chinese bank or courier company. The caller might claim that your identity was used to send parcels containing fake passports or weapons, or to apply for overseas credit cards. They then refer you to another caller claiming to be a Chinese official, who will ask &mdash; or even threaten &mdash; you to give them personal information such as your passport or bank account number, internet banking credentials or One-Time Password (OTP).</p></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Calls or messages from courier companies, telcos or government agencies asking you for your personal particulars, bank account details, or OTPs</li>
    <li>Scare tactics that link you to crimes such as pending court cases, your mobile number being used in a crime, that your Wi-Fi has been compromised, or urgent requests that require your immediate attention</li>
    <li>Threatening to escalate matters to the police if you do not cooperate</li>
    <li>Numbers calling from a &lsquo;+&rsquo; number, even if it&rsquo;s &lsquo;+65&rsquo; it does not mean it&rsquo;s from Singapore<br />
    <br />
    <br />
    <br />
    </li>
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_More">
                                <div> <ul>
    <li>Calls or messages from courier companies, telcos or government agencies asking you for your personal particulars, bank account details, or OTPs</li>
    <li>Scare tactics that link you to crimes such as pending court cases, your mobile number being used in a crime, that your</div>
                                <div class="text-center">
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Beware of incoming calls with the "+" prefix.&nbsp;The &lsquo;+&rsquo; sign prefix will be displayed on phone screens for all international incoming calls. Exercise extra caution when picking up such phone calls, especially if you are not expecting any overseas calls.&nbsp;</li>
    <li>Never disclose personal particulars, banking and credit card details and OTPs to anyone, especially over unsolicited phone calls</li>
    <li>Hang up immediately if the caller cannot identify himself properly</li>
    <li>Always verify the authenticity of the information with the official website or sources</li>
    <li>No government agencies will ask you for your personal details or bank transfers over the phone or through automated voice machines</li>
    <li>Do not click on URL links provided in unsolicited emails and text messages<br />
    <div>&nbsp;</div>
    </li>
</ul></div>
                                <div class="text-center">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_More">
                                <div> <ul>
    <li>Beware of incoming calls with the "+" prefix.&nbsp;The &lsquo;+&rsquo; sign prefix will be displayed on phone screens for all international incoming calls. Exercise extra caution when picking up such phone calls, especially if you are not expecting any overseas calls.&nbsp;</li>
    <li>Never disclose personal</div>
                                <div class="text-center">
...
<div class="stories overflow-hide">
    ...
    <div class="d-none d-sm-block">
        <div class="row pb-4">
            <div class="col-lg-5 text-muted mb-2 pt-2" id="divPagingInfo">Showing 6 of 1930 Stories</div>
                    ...
                    <div class="col-xs-auto col-md-3">
                        <select class="custom-select mb-2" id="ddlScamType" onchange="ddlScamOnSelect();">
                            <option value="">All Type</option>
                                ...
                                <option value="impersonation-scam" selected>Impersonation Scam</option>
    ...
    <?php
        $allTypeIds=fetchTypeOfScam_forEach($conn,'impersonation-scam');
        rsort($allTypeIds);
        // print_r($allTypeIds)
