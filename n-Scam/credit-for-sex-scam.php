...
<main role="main"> 
    ...
    <script type="text/javascript">
        $(function () {
            $(document).prop('title', 'Credit-for-Sex Scam');
        });
    </script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-right order-lg-2">
                    <img class="img-fluid" src="../default-album/top-banners/credit-for-sex-scamdcee.png?sfvrsn=98115d7_2" alt="Credit-for-Sex Scam" />
                </div>
                <div class="col-md-6 my-auto order-lg-1 text-center text-sm-left">
                    <h1>
                        WHAT IS A Credit-for-Sex Scam <br />
                    </h1>
                    <p class="lead"><p>In this scam, a stranger befriends her victim through social media platforms such as WeChat. The scammer talks the victim into buying them a purchase or gift card (e.g. Alipay Purchase Cards, iTunes cards, etc) in exchange for a meet-up, date or sexual favours.</p></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="counter">
                    ...
                    <div class="tab-content mt-5" id="myTabContent">
                        <div id="content1" class="tab-pane fade active" role="tabpanel" aria-labelledby="content1-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsLookOutId_Less" style="display:none;">
                                <div><ul>
    <li>Social media sites and dating platforms are their hunting grounds</li>
    <li>Requests for payments through credits or shopping gift-cards</li>
    <li>Often pose as young, attractive women from overseas who offer their massage, escort or sexual services in exchange for credits or shopping gift-cards. Persistent in tempting you and sometimes bring in &lsquo;managers&rsquo; to threaten you if you wish to end the transaction<br />
    <div>&nbsp;</div>
    </li>
</ul></div>
    ...
    <li>Social media sites and dating platforms are their hunting grounds</li>
    <li>Requests for payments through credits or shopping gift-cards</li>
    <li>Often pose as young, attractive women from overseas who offer their massage, escort or sexual services in exchange for credits or shopping</div>
                                <div class="text-center">
                        ...
                        <div id="content2" class="tab-pane fade" role="tabpanel" aria-labelledby="content2-tab">
                            ...
                            <div class="read-more-wrap lead text-left" id="MaincontainsProtectId_Less" style="display:none;">
                                <div><ul>
    <li>Be wary of people offering sex in exchange of gift-cards or shopping-credits</li>
    <li>Do not give personal details or receipts showing PINs to strangers you meet online<br />
    <div>&nbsp;</div>
    </li>
</ul>
<p>To provide information related to such crimes, please call the Police hotline at 1800-255-0000, or submit it online at <a href="https://www.police.gov.sg/iwitness" target="_blank">www.police.gov.sg/iwitness</a>. For urgent Police assistance, please dial '999'.<br />
<br />
If you have encountered such a scam, report the fraudulent profile to WeChat via the app itself. Steps on how to report such accounts can be found&nbsp;<a href="https://help.wechat.com/cgi-bin/micromsg-bin/oshelpcenter?opcode=2&amp;id=1208117b2mai141024y63euy&amp;lang=en&amp;plat=android&amp;Channel=helpcenter">here</a></p></div>
                                <div class="text-center">
...
<p>To provide information related to such crimes, please call</div>
                                <div class="text-center">
...
<div class="stories overflow-hide">
    ...
    <div class="d-none d-sm-block">
        <div class="row pb-4">
            <div class="col-lg-5 text-muted mb-2 pt-2" id="divPagingInfo">Showing 6 of 212 Stories</div>
                    ...
                    <div class="col-xs-auto col-md-3">
                        <select class="custom-select mb-2" id="ddlScamType" onchange="ddlScamOnSelect();">
                            <option value="">All Type</option>
                                ...
                                <option value="credit-for-sex-scam" selected>Credit-for-Sex Scam</option>
